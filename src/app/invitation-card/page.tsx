                        ...
                        <div className="flex-auto">
                            <div className="ornaments-wrapper">
                                <div className="protocol-frame">
                                    ...
                                    >
                                        <img
                                            src="https://katsudoto.id/media/template/custom/niar-rahmat/assets/prokes-frame-min.png"
                                            alt=""
                                        />
                                    </div>
                                    <div className="orn-prokes-top tr-1">
                                        ...
                                        >
                                            <img
                                                src="https://katsudoto.id/media/template/custom/niar-rahmat/assets/Orn-14-min.png"
                                                alt=""
                                            />
                                        </div>
                                    </div>
                                    <div className="orn-prokes-top tr-2">
                                        ...
                                        >
                                            <img
                                                src="https://katsudoto.id/media/template/custom/niar-rahmat/assets/Orn-04-min.png"
                                                alt=""
                                            />
                                        </div>
                                    </div>
                                    <div className="orn-prokes-top tr-3">
                                        ...
                                        >
                                            <img
                                                src="https://katsudoto.id/media/template/custom/niar-rahmat/assets/Orn-05-min.png"
                                                alt=""
                                            />
                                        </div>
                                    </div>
